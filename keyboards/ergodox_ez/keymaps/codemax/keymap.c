...
// right thumb -------------------------------------------------------------------------------------------------
  ...
  [SYM] = LAYOUT_ergodox_base_wrapper(
    ________________BLANK_____________________,  ___,      ___, ________________BLANK_____________________,                       
    ________________SYM_L1____________________,  XXX,      ___, ________________SYM_R1____________________,               
    ________________SYM_L2____________________,                 ________________SYM_R2____________________,  
    ________________SYM_L3____________________,  ___,      ___, ________________SYM_R3____________________,
    ___, ___,     _____SYM_BOTTOM_L1_________,                    _____SYM_BOTTOM_R1_________, ___, ___,       
                                             ___, ___,  ___, ___,
                                                SYM_L2,  SYM_R2,
                                        SYM_L1, SYM_L3,   SYM_R3, SYM_R1 
  ),
  [SYMPLUS] = LAYOUT_ergodox_base_wrapper(
    ________________BLANK_____________________,  ___,      ___, ________________BLANK_____________________,                       
    ________________SYMP_L1___________________,  XXX,      ___, ________________SYMP_R1___________________,               
    ________________SYMP_L2___________________,                 ________________SYMP_R2___________________,  
    ________________SYMP_L3___________________,  ___,      ___, ________________SYMP_R3___________________,
    ___, ___,     _____SYMP_BOTTOM_L1________,                    _____SYMP_BOTTOM_R1________, ___, ___,       
                                             ___, ___,  ___, ___,
                                                SYMP_L2,  SYMP_R2,
                                        SYMP_L1, SYMP_L3,   SYMP_R3, SYMP_R1 
  ),
  [UNICODE] = LAYOUT_ergodox_base_wrapper(
    ________________BLANK_____________________,  ___,      ___, ________________BLANK_____________________,                       
    ________________UNI_L1____________________,  XXX,      ___, ________________UNI_R1____________________,               
    ________________UNI_L2____________________,                 ________________UNI_R2____________________,  
    ________________UNI_L3____________________,  ___,      ___, ________________UNI_R3____________________,
    ___, ___,     _____UNI_BOTTOM_L1_________,                    _____UNI_BOTTOM_R1_________, ___, ___,       
                                             ___, ___,  ___, ___,
                                                UNI_L2,  UNI_R2,
                                        UNI_L1, UNI_L3,   UNI_R3, UNI_R1 
  ),
