...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [COLEMAK] = LAYOUT_ergodox_base_wrapper(
        ________________MEDIA_____________________, KC_MUTE,          TO(PHOTOSHOP), ________________BLOCK_____________________, 
        ________________COLEMAK_L1________________, KC_VOLU,          RCS(KC_E), ________________COLEMAK_R1________________, 
  ...
  [NUMPAD] = LAYOUT_ergodox_base_wrapper(
    ...
    ________________NUMPAD_L1_________________,  TG(GAME), ___, ________________NUMPAD_R1_________________,               
  ...
  [NAV] = LAYOUT_ergodox_base_wrapper(
    ...
    ___, ___,     _____NAV_BOTTOM_L1_________,                    _____NAV_BOTTOM_R1_________, ___, DEL_LINE,       
                                             ___, ___,  ___, ___,
                                                NAV_L2,  NAV_R2,
...
[MIRRORED] = LAYOUT_ergodox_base_wrapper(
  ...
  [PHOTOSHOP] = LAYOUT_ergodox(
  // left hand ---------------------------------------------------------------------------------------------------
    KC_ESCAPE, KC_1,  KC_2,     KC_3,      KC_4,    KC_5, ___,             
 OSL(NUMPAD), ES_LBRC,  ES_RBRC,     ___,      ___,    ___, ___,               
...
// right hand --------------------------------------------------------------------------------------------------
                                 ...
                                 ___, ___,  ___,      ___,    ___,     ___,  TO(COLEMAK),
                                      ___, ___,  ___, ___,  ___,   ___,
                                 ___, ___,  ___,      ___,      ___,     ___,   ___,
                                            ___,      ___,      ___,     ___,   ___,
// right thumb -------------------------------------------------------------------------------------------------
