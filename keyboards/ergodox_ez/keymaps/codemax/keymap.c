...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [COLEMAK] = LAYOUT_ergodox_base_wrapper(
        ...
        ________________COLEMAK_L3________________, ES_LPRN,  ES_RPRN, ________________COLEMAK_R3________________,
...
[MIRRORED] = LAYOUT_ergodox_base_wrapper(
  ...
  [SPANISH] = LAYOUT_ergodox_base_wrapper(
    ...
    ________________SPANSH_L3_________________,  ___,       ___, ________________SPANSH_R3_________________,    
